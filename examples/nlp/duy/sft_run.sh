python train_gpt_sft.py \
   ...
   model.restore_from_path=/home/ubuntu/NeMo/NeMo-Aligner/examples/nlp/duy/ckpts/qwen2.5-7b-nemo \
   model.optim.lr=5e-6 \
   ...
   model.data.train_ds.file_path=/home/ubuntu/NeMo/NeMo-Aligner/examples/nlp/duy/fn_calling_data/train.jsonl \
   model.data.validation_ds.micro_batch_size=1 \
   model.data.validation_ds.global_batch_size=128 \
   model.data.validation_ds.file_path=/home/ubuntu/NeMo/NeMo-Aligner/examples/nlp/duy/fn_calling_data/val.jsonl \
